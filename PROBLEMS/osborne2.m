...
function y = osborne2(x)
    w = [1.366 1.191 1.112 1.013 0.991 0.885 0.831 0.847 0.786 0.725 0.746 0.679 ...
         0.608 0.655 0.616 0.606 0.602 0.626 0.651 0.724 0.649 0.649 0.694 0.644 ...
    ...
    t = 0.1.*[0:64];
    f = w - x(1).*exp(-x(5).*t) - x(2).*exp(-x(6).*(t-x(9)).^2) - ...
